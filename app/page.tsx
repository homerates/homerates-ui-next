...
function AnswerBlock({ meta }: { meta?: ApiResponse }) {
  ...
  // Prefer friendly line from API; else construct from FRED; else fallback to answer
  const primary =
    meta.message ??
    meta.summary ??
    (meta.fred &&
    ...
    <div style={{ display: 'grid', gap: 10 }}>
      ...
      {meta.paymentDelta && (
        <div style={{ fontSize: 13 }}>
          Every 0.25%  | ‰ˆ <b>${meta.paymentDelta.perQuarterPt}/mo</b> on ${meta.paymentDelta.loanAmount.toLocaleString()}.
        </div>
      )}
    </div>
  );
    ...
    <>
      ...
      <aside className="sidebar">
        ...
        <div className="side-bottom">
          <button className="btn"> | š™ï¸ Settings</button>
